...
setwd('~/Dropbox/teaching/Taller de R/GitHub/Clases/Clase 11') # Cambiar este directorio
getwd()
...
print('Intentemos responder la siguiente pregunta: Que variables pueden estar asociadas a la desiccion de tomar en arriendo o no un inmueble?')
